...
function verificarChute() {
    ...
    if (numerosecreto === guess) {
        // Atualiza o texto de vitória antes de qualquer outra ação
        ...
        // Habilita o botão para reiniciar
        botaoReiniciar.removeAttribute('disabled');
        
        // 1. Fala o texto de vitória
...
// O botão de reiniciar agora reinicia o jogo sem recarregar a página
